...
# Create labels
& $gh label create "enhancement"     --description "New feature or request"   --color "a2eeef" --repo $repo 2>$null
& $gh label create "high priority"   --description "High priority feature"   --color "d93f0b" --repo $repo 2>$null
& $gh label create "medium priority" --description "Medium priority feature" --color "fbca04" --repo $repo 2>$null
& $gh label create "low priority"    --description "Low priority feature"    --color "0e8a16" --repo $repo 2>$null

Write-Host "=== Creating high priority issues ==="

& $gh issue create --repo $repo --title "WhatsApp Integration" --label "enhancement,high priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Slack Integration" --label "enhancement,high priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Scheduled Reports (email)" --label "enhancement,high priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Data Export (CSV/XLSX/PDF)" --label "enhancement,high priority" --body @"
## Description
...
Write-Host "=== Creating medium priority issues ==="

& $gh issue create --repo $repo --title "RAG / Document Sources" --label "enhancement,medium priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "External API Keys" --label "enhancement,medium priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Collaborative Workspaces" --label "enhancement,medium priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Automatic Data Source Sync" --label "enhancement,medium priority" --body @"
## Description
...
Write-Host "=== Creating low priority issues ==="

& $gh issue create --repo $repo --title "Auto ML" --label "enhancement,low priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Custom Chart Editor" --label "enhancement,low priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Full Audit Trail" --label "enhancement,low priority" --body @"
## Description
...
& $gh issue create --repo $repo --title "Outgoing Webhooks" --label "enhancement,low priority" --body @"
## Description
...
Write-Host ""
Write-Host "=== All 12 issues created successfully ==="
