...
async def generate_table_summary_sql(
    ...
    system_report = (
        ...
        "## Overview\n"
        "[Brief description of the table's role and data type.]\n\n"
        "## Data Description\n"
        "| Column | Type | Description |\n"
        "|---|---|---|\n"
        "| [col1] | [type] | [what it represents] |\n"
        "| [col2] | [type] | [what it represents] |\n\n"
        "## Key Metrics\n"
        "- [**Metric 1:** Summarized data like counts, sums, averages]\n"
        "- [**Metric 2:** Summarized data like counts, sums, averages]\n\n"
        "## Insights & Observations\n"
        "- [**Observation 1:** Notable patterns found in the query results]\n"
